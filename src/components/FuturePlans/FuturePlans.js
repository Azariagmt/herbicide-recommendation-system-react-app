      ...
      <section className="section-about">
        ...
        <div className="row">
          <div className="col-1-of-2">
            ...
            <p className="paragraph">
              -Out image processing model detects between different species of
              invasive alien plant species(currently the three common ones here
              in Ethiopia parthenium weed (Parthenium hysterophorus),prosopis
